...
namespace Exwhyzee.ESS.Areas.Edu.Controllers
{
    ...
    public class LiveClassLevelsController : Controller
    {
        ...
        public async Task<ActionResult> Index(string searchString, string currentFilter, int? page)
        {
            ...
            var items = db.LiveClassLevel.Where(x => x.Name != "");
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            LiveClassLevel classLevel = await db.LiveClassLevel.FindAsync(id);
            if (classLevel == null)
            {
                return HttpNotFound();
            }
        ...
        public async Task<ActionResult> Create(LiveClassLevel classLevel)
        {
            if (ModelState.IsValid)
            {
                db.LiveClassLevel.Add(classLevel);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(LiveClassLevel classLevel)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            LiveClassLevel classLevel = await db.LiveClassLevel.FindAsync(id);
            db.LiveClassLevel.Remove(classLevel);
            await db.SaveChangesAsync();
            return RedirectToAction("Index");
        }
